...
```bash
Username for 'https://github.com': AndreyChemodurov
Password for 'https://AndreyChemodurov@github.com': 
...
remote:      https://github.com/AndreyChemodurov/lab02/pull/new/patch1
remote: 
To https://github.com/AndreyChemodurov/lab02.git
...
```bash
Из https://github.com/AndreyChemodurov/lab02
